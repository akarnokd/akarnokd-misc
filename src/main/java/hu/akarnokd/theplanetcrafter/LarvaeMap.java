...
public class LarvaeMap {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        var Butterfly11Larvae = "Butterfly11Larvae";
        var Butterfly12Larvae = "Butterfly12Larvae";
        var Butterfly13Larvae = "Butterfly13Larvae";
        var Butterfly14Larvae = "Butterfly14Larvae";
        var Butterfly15Larvae = "Butterfly15Larvae";
        var Butterfly16Larvae = "Butterfly16Larvae";
        var Butterfly17Larvae = "Butterfly17Larvae";
        var Butterfly18Larvae = "Butterfly18Larvae";
        
        var spawns = List.<Area>of(
                new Area("ParadiseLost", 1254,143,2929,98,42,117, Butterfly18Larvae, Butterfly17Larvae, Butterfly14Larvae, Butterfly13Larvae, Butterfly12Larvae),
        ...
        var labels = Map.<String, String>of(
                ...
                "Butterfly16Larvae", "- Imeo (16)",
                "Butterfly17Larvae", "- Serena (17)",
                "Butterfly18Larvae", "- Golden (18)"
        );
