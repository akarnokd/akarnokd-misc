 ...
 * @author akarnokd
 */
public class ShakespearePlaysScrabbleWithRxJava4ObservableOpt extends ShakespearePlaysScrabble {
...
//        System.out.println(finalList2);
    ...
    public static void main(String[] args) throws Throwable {
        ShakespearePlaysScrabbleWithRxJava4ObservableOpt s = new ShakespearePlaysScrabbleWithRxJava4ObservableOpt();
        s.init();
