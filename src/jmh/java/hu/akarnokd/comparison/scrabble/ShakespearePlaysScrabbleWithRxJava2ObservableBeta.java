...
/**
 * Shakespeare plays Scrabble with RxJava 2 Observable (slightly modified).
 * @author José
 * @author akarnokd
 */
public class ShakespearePlaysScrabbleWithRxJava2ObservableBeta extends ShakespearePlaysScrabble {
