 ...
 * @author akarnokd
 */
public class ShakespearePlaysScrabbleWithRxJava2FlowableOpt3 extends ShakespearePlaysScrabble {
...
//        System.out.println(finalList2);
    ...
    public static void main(String[] args) throws Exception {
        ShakespearePlaysScrabbleWithRxJava2FlowableOpt3 s = new ShakespearePlaysScrabbleWithRxJava2FlowableOpt3();
        s.init();
