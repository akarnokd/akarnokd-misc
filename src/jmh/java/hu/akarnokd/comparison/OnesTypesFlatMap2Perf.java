...
@Fork(value = 1)
@State(Scope.Thread)
public class OnesTypesFlatMap2Perf {
    ...
    public void setup() throws Exception {
        Maybe<Integer> maybeOne = Maybe.fromCallable(() -> 1);
        ...
        Single<Integer> singleOne = Single.fromCallable(() -> 1);
        ...
        Mono<Integer> monoOne = Mono.fromCallable(() -> 1);
