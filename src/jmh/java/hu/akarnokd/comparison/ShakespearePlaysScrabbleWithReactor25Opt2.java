 ...
 * @author José
 */
public class ShakespearePlaysScrabbleWithReactor25Opt2 extends ShakespearePlaysScrabble {
    ...
    */ 
    ...
    public List<Entry<Integer, List<String>>> measureThroughput() throws InterruptedException {
        ...
        Function<String, Mono<HashMap<Integer, LongWrapper>>> histoOfLetters =
...
//        System.out.println(finalList2);
    ...
    public static void main(String[] args) throws Exception {
        ShakespearePlaysScrabbleWithReactor25Opt2 s = new ShakespearePlaysScrabbleWithReactor25Opt2();
        s.init();
